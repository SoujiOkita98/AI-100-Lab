...
**一个研究级的全球 600+ AI 与机器人初创企业数据库 — 融资轮次、创始人背景、投资者网络及创始人来源分析。**
...
```
AI-100-Lab/
  companies/           # 615个Markdown文件 — 每家企业一个
...
| 文件 | 行数 | 说明 |
|------|-----:|------|
| `companies_clean.csv` | 615 | 每行一家企业 — 所有标准化字段 |
| `rounds_clean.csv` | 1,259 | 每行一轮融资 — 阶段、日期、金额、估值、投资方 |
| `founders_clean.csv` | 1,314 | 每行一位创始人 — 姓名、职务、背景、来源 |
| `companies_clean.json` | 615 | 嵌套格式 — 企业+创始人+融资轮次合并 |
