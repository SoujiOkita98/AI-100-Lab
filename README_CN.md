...
**一个研究级的全球 500+ AI 与机器人初创企业数据库 — 融资轮次、创始人背景、投资者网络及创始人来源分析。**

以斯坦福商学院研究项目的标准构建：每项数据可追溯来源，不确定性明确标注，质量优先于完整性。
...
| 领投方 | 93% | 每轮记录 |
| 来源链接 | 79% | 可追溯至原始报道 |
| 创始人来源/族裔 | 89% | 基于姓名、背景和公开信息推断 |
| 创始人经历 | 66% | 教育、前公司、重要经验 |
| 总部所在地 | 73% | 城市+国家 |
| 官网 | 59% | |
| 最新估值 | 35% | 种子轮/早期通常不公开（市场常态）|
| 营收信号 | 11% | 仅限公开披露的数据 |
...
```
AI-100-Lab/
  companies/           # 513个Markdown文件 — 每家企业一个
...
| 文件 | 行数 | 说明 |
|------|-----:|------|
| `companies_clean.csv` | 513 | 每行一家企业 — 所有标准化字段 |
| `rounds_clean.csv` | 918 | 每行一轮融资 — 阶段、日期、金额、估值、投资方 |
| `founders_clean.csv` | 629 | 每行一位创始人 — 姓名、职务、背景、来源 |
| `companies_clean.json` | 513 | 嵌套格式 — 企业+创始人+融资轮次合并 |
