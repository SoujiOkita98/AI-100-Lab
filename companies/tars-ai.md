...
- name: Chen Yilun
  role: CEO
  background: Former CTO/Chief Scientist Huawei autonomous driving. Ex-DJI machine vision lead.
  origin: Chinese
- name: Ding Wenchao
  role: Chief Scientist
  background: Huawei Genius Youth recruit.
  origin: Chinese
- name: Li Zhenyu
  role: Chairman
...
Embodied AI for smart manufacturing and intelligent logistics.
