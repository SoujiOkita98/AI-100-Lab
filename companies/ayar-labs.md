...
sector: AI Chips / Optical Interconnects
one_liner: Silicon-photonic optical interconnects replacing copper — 20x higher throughput per watt for AI data centers. MIT
  spinout.
status: active
funding_rounds:
- stage: Series C
...
- name: Vladimir Stojanovic
  ...
  origin: Serbian (inferred from name)
- name: Chen Sun
  role: Co-Founder
...
Silicon-photonic optical interconnects replacing copper — 20x higher throughput per watt for AI data centers. MIT spinout.
